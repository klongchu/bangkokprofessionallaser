...
include './service/devicesFService.php';
include './controller/devicesFController.php';
...
<?php
                                $util = new Utility();
                                $controller = new devicesFController();
                                ...
                                foreach ($_data as $key => $value) {
                                    ...
                                    $abc = "a";
$str = trim($_data[$key]['s_devices_' . $_SESSION["main_lan"]]); 

$url_name = ereg_replace('[[:space:]]+', '', trim($str));                                   
                                    ?>
...
<h3 class="uk-margin-remove">
	 <div class="logo">
	 <a href="<?= $url_name; ?>-<?= $_data[$key]['id']; ?>.html" title="<?= $_data[$key]['s_devices_' . $_SESSION["main_lan"]]; ?>">
...
<li class="element element-itemlink">
	 <a href="<?= $url_name; ?>-<?= $_data[$key]['id']; ?>.html">Show details</a></li></ul>
</div>
</div>
                                    <?php
                                }
